...
\NewsItem{CHANT D'ENTRÉE}
	\input{\chants/dieu_nous_accueille}
...
% -----
\NewsItem{1\iere{} LECTURE} Gn 18, 1-10a
% -----

\NewsItem{PSAUME}
\input{\psaumes/psaume_14}

% -----
\NewsItem{2\ieme{} LECTURE}  Col 1, 24-28

\NewsItem{ACCLAMATION}
\input{\messe/alleluia}

\NewsItem{ÉVANGILE} Lc 10, 38-42
...
\NewsItem{COMMUNION}\\
\input{\chants/si_nous_partageons}

\NewsItem{ANNONCES PAROISSIALES}


\NewsItem{CHANT D'ENVOI}\\
\input{\chants/christ_aujourdhui}
...
\begin{itemize}
\item[\Cross] José Armindo  Andrade MAGALHAES 
\item[\Cross] Arminda   MAGALHAES
\item[\Cross] Andrade Maria Das Dores  MAGALHAES
\item[\Cross]  José de MAGALHAES
\item[\Cross]  Anna de CARVALHO    
\item[\Cross]  Alda das Dares Arauja MATO.
\end{itemize}
...
\\  \normalsize \textit{16\ieme{} dimanche du Temps Ordinaire - C}
\\ \large Dimanche 20 juillet  2025}

...
\NewsItem{CHANT D'ENTRÉE}
	\input{\chants/entrez_dieu_est_en_attente}
...
\NewsItem{COMMUNION}
\input{\chants/en_accueillant_lamour}

\NewsItem{ANNONCES PAROISSIALES}


\NewsItem{CHANT D'ENVOI}
\input{\chants/chantez_avec_moi}
...
\\  \normalsize \textit{14\ieme{} dimanche du Temps Ordinaire - C}
\\ \large Dimanche 06 juillet  2025}

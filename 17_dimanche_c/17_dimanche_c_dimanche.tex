...
\input{\pu/notre_pere_nous_te_supplions}
...
\NewsItem{COMMUNION}
\input{\chants/qui_donc_est_dieu}

\NewsItem{ANNONCES PAROISSIALES}


\NewsItem{CHANT D'ENVOI}\\
\input{\chants/esprit_saint_qui_nous}
...
\item[\Cross] Marthe De rynck et familles 
\item[\Cross] Famille Gennetay. 
\item[\Cross] Henri Schneider
\end{itemize}
...
\\  \normalsize \textit{17\ieme{} dimanche du Temps Ordinaire - C}
\\ \large Dimanche 27 juillet  2025}
